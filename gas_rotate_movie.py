...
nrange = [289,299,308,309,319,329,349]

## particle properties

coods = E.readArray("SNAPSHOT", sim, tag, "/PartType0/Coordinates", numThreads=1)
pmass = E.readArray("SNAPSHOT", sim, tag, "/PartType0/Mass", numThreads=1)
phsml = E.readArray("SNAPSHOT", sim, tag, "/PartType0/SmoothingLength", numThreads=1)
...
for i in nrange:
    ...
    fig.savefig('movie_images/gas_test_zoom_1_r_1_p_%03d.png'% i, bbox_inches='tight', pad_inches=0)
